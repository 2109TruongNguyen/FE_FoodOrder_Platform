          ...
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">
                <img src="..\src\assets\logo\logo.png" style={{ maxHeight: "20px" }} alt="Logo" />
                &nbsp;&nbsp;VietNamese Food
              </h6>
              <p>
                Nền tảng bán đồ ân uy tín, an toàn, chất lượng đầu hàng Việt Nam.
              </p>
            </MDBCol>
